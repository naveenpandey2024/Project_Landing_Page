...
const HomePage = () => {
  ...
  return (
    <div
      style={{
        height: "100vh", // Ensures content fits within viewport height
    ...
    >
      ...
      <div
        ...
        style={{
          flex: 1, // Makes this section expand within available space
          overflow: "hidden", // Prevents any scrolling in this section
        }}
      >
        <Features />
        <Feature2 />
